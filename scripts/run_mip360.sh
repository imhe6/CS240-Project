...
GPU=1
CONFIG="../configs/mip360.yml" # 默认值
OUTPUT_DIR="output/mip360/"    # 默认值
...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "Options:"
            echo "  -o, --output    Output directory (default: output/mip360/)"
            echo "  -c, --config    Path to config file (default: ../configs/mip360.yml)"
            echo "  -gpu, --gpu     CUDA_VISIBLE_DEVICES ID (default: 1)"
